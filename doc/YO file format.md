...
Note that using 0 or leaving an entry blank may result in the columns not lining up properly, as in this case. One may correct this by entering additional decimals on the zeros. Finally, we will describe the material, antenna height and pair two antennas:
