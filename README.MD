...
There are a number of limitations in these importers as the various formats support different features and options. See the "file format" documents in the doc folder for more details.
