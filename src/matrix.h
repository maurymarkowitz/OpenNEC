...
void fill_excitation_vector(nec_context_t *restrict ctx, double p1, double p2, double p3, double p4, double p5, double p6, int ipr, complex double *restrict e);
...
void solve_symmetric(nec_context_t *restrict ctx, complex double *restrict a, int *restrict ip, complex double *restrict b, int neq, int nrh, int np, int n, int mp, int m);
