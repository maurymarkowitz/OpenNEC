...
typedef struct card_t
{
  ...
  bool int_form_inline[4]; /**< true if the integer field was defined by an inline formula */
  bool flt_form_inline[8]; /**< true if the float field was defined by an inline formula */
